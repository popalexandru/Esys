...
@AndroidEntryPoint
class GoldEarnedFragment(private val match: Match, private val name : String) : Fragment(), MatchViewerAdapter.onClicked {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val participants = match.participants.sortedWith(compareBy{it.stats.goldEarned})
    ...
    private fun populateRecyclerViews(teamOne: List<Participant>, teamTwo: Int, myId: Int) {
        val adapterOne = GoldEarnAdapter(myId)
        ...
        adapterOne.maxValue = teamOne[0].stats.goldEarned.toLong()
