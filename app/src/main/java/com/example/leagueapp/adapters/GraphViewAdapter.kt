...
class GraphViewAdapter(private val id : Int) : ListAdapter<Participant, GraphViewAdapter.CakeViewHolder>(
    DiffCallback()
){
    var myTeam = 0
    var maxValue = 0L
    ...
    inner class CakeViewHolder(private val binding : LayoutGraphItemBinding) : RecyclerView.ViewHolder(binding.root){
        ...
        fun bind(champ : Participant){
            binding.apply {
                ...
                progressValue.progress = champ.stats.totalDamageDealtToChampions.toInt()
                ...
                value.setText(champ.stats.totalDamageDealtToChampions.toString())
